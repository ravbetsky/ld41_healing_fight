...
module.exports = __webpack_require__(/*! /Users/artem/Projects/ld41/ld41_healing_fight/src/main.js */302);
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: centerGameObjects, timeout */
/*! exports used: centerGameObjects, timeout */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sprites_Enemy__ = __webpack_require__(/*! ../sprites/Enemy */ 316);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sprites_Player__ = __webpack_require__(/*! ../sprites/Player */ 311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sprites_AI__ = __webpack_require__(/*! ../sprites/AI */ 314);
/* globals __DEV__ */
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  create() {
    ...
    this.enemy = new __WEBPACK_IMPORTED_MODULE_1__sprites_Enemy__["a" /* default */]({
      game: this.game,
      x: 0,
      y: 300,
      asset: 'player',
      frame: 0,
      AI: new __WEBPACK_IMPORTED_MODULE_3__sprites_AI__["a" /* default */]()
    });
    ...
    this.game.physics.enable(this.enemy, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Physics.ARCADE);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Sprite {
  ...
  releaseMovements(movements) {
    ...
    movements.reduce((acc, [movement, duration]) => {
      return acc.then(() => this[movement]()).then(() => Object(__WEBPACK_IMPORTED_MODULE_1__utils__["b" /* timeout */])(duration));
...
class AI {
  ...
  calcMovements(position, circle) {
    ...
    return [['moveRight', 800], ['moveUp'], ['moveRight', 500], ['moveLeft', 200], ['moveUp'], ['moveLeft', 700], ['stop']];
  }
}
...
class Raycast {
  constructor({ game, sprite }) {
    this.game = game;
    this.sprite = sprite;
    this.lineTopRight = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Line();
    this.lineTopLeft = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Line();
    this.lineBottomRight = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Line();
    this.lineBottomLeft = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Line();
  }
  ...
  raycast(layer) {
    ...
    layer.dirty = true;
    return [tileHitsTopLeft.length > 0, tileHitsTopRight.length > 0, tileHitsBottomLeft.length > 0, tileHitsBottomRight.length > 0];
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = Raycast;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Raycast__ = __webpack_require__(/*! ./Raycast */ 315);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__(/*! ../utils */ 309);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Sprite {
  constructor({ game, x, y, asset, frame, AI }) {
    ...
    this.animations.add("right", [0, 1, 2], 10, true);
    this.animations.add("left", [4, 5, 6], 10, true);
    this.raycast = new __WEBPACK_IMPORTED_MODULE_1__Raycast__["a" /* default */]({ sprite: this, game });
    // this.AI = AI;
  ...
  releaseMovements(movements) {
    this.autoPilot = true;
    movements.reduce((acc, [movement, duration]) => {
      return acc.then(() => this[movement]()).then(() => Object(__WEBPACK_IMPORTED_MODULE_2__utils__["b" /* timeout */])(duration));
    }, Promise.resolve()).then(() => this.autoPilot = false);
  }
